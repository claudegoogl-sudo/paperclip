...
function bindingTitle(binding: EgressBindingReview): string {
...
function BindingCard({
  ...
  const enforceMutation = useMutation({
    mutationFn: (allowEmpty: boolean) =>
      secretsApi.enforceEgressBinding(companyId, binding.id, allowEmpty),
    onSuccess: () => {
      pushToast({
        tone: "success",
