...
// ---------------------------------------------------------------------------
// PLA-1889 — operator-only review + set-allowlist + enforce-flip surface for
...
// PLA-735 secret-binding surface in `routes/secrets.ts`, same authz shape:
...
// company-scoped (path-scoped `companyId`), but per CTO amendment A2 on
// PLA-1885 the runtime deny decision this feeds is NOT per-tenant — it unions
