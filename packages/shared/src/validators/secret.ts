...
// PLA-1889 — sibling operator surface for the plugin config-key egress
...
// PLA-735 pair above: no plugin/company/config-key id in the body (path
// params only) and no agent-passable fields.
