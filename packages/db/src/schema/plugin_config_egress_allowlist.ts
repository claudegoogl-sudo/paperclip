...
/**
 * `plugin_config_egress_allowlist` — extends the per-binding egress allowlist
 * mechanism ({@link ../../../server/src/handle-egress.ts})
 ...
 *
 * Operator decision (amendment A2): the runtime deny decision is
