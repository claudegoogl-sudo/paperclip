-- PLA-1889 sibling of 0139_egress_would_deny_observations.sql for the
-- config-key egress allowlist. Records, per PLUGIN (not per company — the
-- enforcement decision is company-agnostic per CTO amendment A2 on
-- PLA-1885), the egress-parser-NORMALIZED destinations (scheme+host+port
