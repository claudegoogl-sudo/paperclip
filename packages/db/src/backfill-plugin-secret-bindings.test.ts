...
// Exercises migration 0090_backfill_plugin_secret_bindings against representative
// pre-state data. The embedded-pg helper boots an already-migrated DB (so 0090 has
...
const BACKFILL_SQL = fs.readFileSync(
  new URL("./migrations/0090_backfill_plugin_secret_bindings.sql", import.meta.url),
  "utf8",
);
...
describeEmbeddedPostgres("0090 backfill company_secret_bindings", () => {
