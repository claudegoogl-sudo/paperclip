...
// Exercises migration 0126_backfill_plugin_secret_bindings against representative
// pre-state data. The embedded-pg helper boots an already-migrated DB (so 0126 has
...
const BACKFILL_SQL = fs.readFileSync(
  new URL("./migrations/0232_backfill_plugin_secret_bindings.sql", import.meta.url),
  "utf8",
);
