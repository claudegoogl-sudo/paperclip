...
describe("isClaudeTransientUpstreamError", () => {
  ...
  it("routes the session-limit failure to provider_quota, not transient", () => {
    // v2026.722.0 split provider-quota exhaustion out of transient-upstream so
    // it gets the recovery monitor rather than a blind ladder retry. The two
    // classifiers must stay mutually exclusive for this input.
